#ifndef NNET_HEPT_OLD_H_
#define NNET_HEPT_OLD_H_
...
void qk_einsum(
    ...
    nnet::transpose_t<data_T, data_T, typename CONFIG_T::transpose_conf_qk>(key, key_transpose);
...
template <class data_T, class res_T, typename CONFIG_T>
void hept_old(data_T query[CONFIG_T::batch_size * CONFIG_T::n_heads * CONFIG_T::seq_len * CONFIG_T::dim_per_head],
          data_T key[CONFIG_T::batch_size * CONFIG_T::n_heads * CONFIG_T::seq_len * CONFIG_T::dim_per_head],
